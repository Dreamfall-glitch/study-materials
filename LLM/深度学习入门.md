...
2. **二分类问题的概率**
   ...
   <center>通过<font> 梯度下降 </font> 降低损失函数，寻找参数</center>

3. **参数更新**

   - w

     **极大似然估计**：假设所有 N 个样本独立同分布，则整个数据集的似然函数 L 是所有样本概率的乘积，取**自然对数**，将乘法变加法，得到对数似然 **ln⁡ L = J(w,b)**

     w 梯度推导过程如下：
     ![](assets/深度学习入门/file-20260514193423522.jpg)
     σ 即 sigmoid 函数
     
   - b

     b 梯度推导过程如下：
     ![](assets/深度学习入门/file-20260514193715977.jpg)
...
4. **分类和回归模型评价指标**
   ...
   - 准确率：
     ...
     \\
     其中，T/F=True/False,P/N=Positive/negative
     $$
